...
type Tenant = Parameters<typeof CloudService.create>[0]["tenant"]
type Tools = Parameters<typeof CloudService.create>[0]["tools"]
...
export function create(input?: {
  ...
  const store = input?.store ?? CloudStore.create()
...
export * as CloudServer from "./server"
